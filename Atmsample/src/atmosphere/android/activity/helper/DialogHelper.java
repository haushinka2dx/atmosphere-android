	...
	public static Dialog createLoginDialog(final Context context, final Dialog dialog, int titleResId, final ResultHandler<LoginResult> resultHandler) {
		...
		okButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				new AtmosTask<LoginResult>(context, LoginResult.class, AtmosTask.RequestMethod.POST).resultHandler(resultHandler).execute(JsonPath.paramOf(BASE_URL + LOGIN_METHOD, param));
			}
		});
